    ...
    <div className={`bg-foreground text-background py-12 ${footerClassName}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="mb-4">
              <span className="text-2xl font-bold text-primary">RestWell</span>
            </div>
            <p className="text-background/70">
              Premium sleep products for better rest and recovery
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-background/20 text-center text-background/70">
          <p>&copy; 2025 RestWell. Sleep better, live better.</p>
        </div>
      </div>
    </div>
  )
